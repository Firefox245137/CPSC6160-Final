...
hud = ui.make_hud( 80,50 ,"level 16", (0, 0, 0), (200, 200, 200), size = 28)
...
goal, drawGoalAction = goat.createGoal((goat.WIDTH-260,200,60,goat.HEIGHT-400), "level17", playerParticle, gloop, dplay, timer)
...
enemy, drawEnemyAction = goat.spawnEnemy([330,200], [0,1], [330,150], [330,500], playerParticle, goat.playerWidth, "level16", gloop, dplay)
enemy2, drawEnemyAction2 = goat.spawnEnemy([380,200], [0,1], [380,150], [380,500], playerParticle, goat.playerWidth, "level16", gloop, dplay)
enemy3, drawEnemyAction3 = goat.spawnEnemy([430,200], [0,1], [430,150], [430,500], playerParticle, goat.playerWidth, "level16", gloop, dplay)

enemy4, drawEnemyAction4 = goat.spawnEnemy([470,230], [1,0], [470,230], [900,230], playerParticle, goat.playerWidth, "level16", gloop, dplay)
enemy5, drawEnemyAction5 = goat.spawnEnemy([470,280], [1,0], [470,280], [900,280], playerParticle, goat.playerWidth, "level16", gloop, dplay)
enemy6, drawEnemyAction6 = goat.spawnEnemy([470,330], [1,0], [470,330], [900,330], playerParticle, goat.playerWidth, "level16", gloop, dplay)

enemy7, drawEnemyAction7 = goat.spawnEnemy([900,380], [1,0], [470,380], [900,380], playerParticle, goat.playerWidth, "level16", gloop, dplay)
enemy8, drawEnemyAction8 = goat.spawnEnemy([900,430], [1,0], [470,430], [900,430], playerParticle, goat.playerWidth, "level16", gloop, dplay)
enemy9, drawEnemyAction9 = goat.spawnEnemy([900,480], [1,0], [470,480], [900,480], playerParticle, goat.playerWidth, "level16", gloop, dplay)
...
entity_list = [wall1, wall2, wall3, wall4, enemy, enemy2, enemy3, enemy4, enemy5, enemy6, enemy7, enemy8, enemy9, coin, coin2, coin3, coin4]
display_list = [drawWallAction1, drawWallAction2, drawWallAction3, drawWallAction4,
				...
				drawEnemyAction7, drawEnemyAction8, drawEnemyAction9, drawCoinAction, drawCoinAction2, drawCoinAction3, drawCoinAction4]
