...
hud = ui.make_hud( 80,50 ,"level 22", (0, 0, 0), (200, 200, 200), size = 28)
...
goal, drawGoalAction = goat.createGoal((200,500,60,60), "level23", playerParticle, gloop, dplay, timer)
...
enemy, drawEnemyAction = goat.spawnEnemy([450,100], [0,1], [450,100], [450,goat.HEIGHT/2-80], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy2, drawEnemyAction2 = goat.spawnEnemy([380,200], [0,1], [380,100], [380,goat.HEIGHT/2-80], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy3, drawEnemyAction3 = goat.spawnEnemy([580,150], [0,1], [580,100], [580,goat.HEIGHT/2-80], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy4, drawEnemyAction4 = goat.spawnEnemy([650,200], [0,1], [650,100], [650,goat.HEIGHT/2-80], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy5, drawEnemyAction5 = goat.spawnEnemy([730,250], [0,1], [730,100], [730,goat.HEIGHT/2-80], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy6, drawEnemyAction6 = goat.spawnEnemy([900,200], [1,0], [900,200], [1100,200], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy7, drawEnemyAction7 = goat.spawnEnemy([1000,300], [1,0], [900,300], [1100,300], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy8, drawEnemyAction8 = goat.spawnEnemy([900,400], [1,0], [900,400], [1100,400], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy9, drawEnemyAction9 = goat.spawnEnemy([1000,480], [1,0], [900,480], [1100,480], playerParticle, goat.playerWidth, "level22", gloop, dplay)

enemy11, drawEnemyAction11 = goat.spawnEnemy([380,450], [0,1], [380,430], [380,goat.HEIGHT-130], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy10, drawEnemyAction10 = goat.spawnEnemy([450,500], [0,1], [450,430], [450,goat.HEIGHT-130], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy12, drawEnemyAction12 = goat.spawnEnemy([520,550], [0,1], [520,430], [520,goat.HEIGHT-130], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy13, drawEnemyAction13 = goat.spawnEnemy([600,430], [0,1], [600,430], [600,goat.HEIGHT-130], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy14, drawEnemyAction14 = goat.spawnEnemy([680,480], [0,1], [680,430], [680,goat.HEIGHT-130], playerParticle, goat.playerWidth, "level22", gloop, dplay)
enemy15, drawEnemyAction15 = goat.spawnEnemy([750,530], [0,1], [750,430], [750,goat.HEIGHT-130], playerParticle, goat.playerWidth, "level22", gloop, dplay)
...
entity_list = [wall1, wall2, wall3, wall4, wall5, wall6, wall7, enemy, enemy2, enemy3, enemy4, enemy5, enemy6, enemy7, enemy8, enemy9,
				 enemy10, enemy11, enemy12, enemy13, enemy14, enemy15, coin1, coin2, coin3, coin4]
display_list = [drawWallAction1, drawWallAction2, drawWallAction3, drawWallAction4, drawWallAction5, drawWallAction6, drawWallAction7, 
				...
				drawEnemyAction10, drawEnemyAction11, drawEnemyAction12, drawEnemyAction13, drawEnemyAction14, drawEnemyAction15, drawCoinAction1,
